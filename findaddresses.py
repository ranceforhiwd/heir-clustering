...
print(fileName)
# pdfFullPath = "/inseptioncopy_new_test.pdf~04.png"
# pdfFullPathArray = pdfFullPath.split("/")
# pdfArray = pdfFullPathArray[1].split("~")
...
tableName = 'appraisal'
# fileName = pdfArray[0]
# fileName = './inseptioncopy_new_test_3.pdf~01.png'
...
for query_results in query_results_all:
    ...
    tableName = 'markup'
    saveResultsInMarkupTable(session,addressDetails,fileName,dbName, tableName,pngFile)
